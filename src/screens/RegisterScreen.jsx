...
export default function RegisterScreen() {
  ...
  const doRegister = () => {
    ...
    if (!nom || !prenom || !email || !tel || !password || !confirm) {
      setAlert({ type: 'ko', msg: '❌ Veuillez remplir tous les champs.' })
      return
    }

    if (password !== confirm) {
      setAlert({ type: 'ko', msg: '❌ Les mots de passe ne correspondent pas.' })
      return
    }

    setAlert({ type: 'ok', msg: '✅ Compte créé ! Redirection...' })
    setTimeout(() => navigate('offre'), 1000)
  }
    ...
    <div className="view active" style={{ flexDirection: 'column' }}>
      ...
      <div className="auth-wrap">
        ...
        <div className="auth-sub">
          Rejoignez Ariano VISA Pay et obtenez votre carte virtuelle.
        </div>
        ...
        <button className="btn btn-blue" style={{ marginTop: 8 }} onClick={doRegister}>
          Créer mon compte
        </button>
